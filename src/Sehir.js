  ...
  useEffect(() => {
    ...
    const getAllCityInfo = async () => {
        let response = await axios.get(
            'https://private-9c5049-sehir2.apiary-mock.com/questions'
            );

            console.log("getAllCityInfo" +JSON.stringify(response.data.SehirListesi));

            setAllCitys(response.data.SehirListesi);
