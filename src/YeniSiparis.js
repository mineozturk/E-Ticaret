              ...
              <form role="form" className="form-horizontal">
                <div className="form-body">
                  <div className="form-group form-md-line-input">
                    <label className="col-md-2 control-label" htmlFor="form_control_1">Siparişi Veren</label>
                  ...
                  <div className="form-group form-md-line-input">
                    <label className="col-md-2 control-label" htmlFor="form_control_1">Sipariş Tarihi</label>
                    <div className="col-md-10">
                  ...
                  <div className="form-group form-md-line-input">
                    <label className="col-md-2 control-label" htmlFor="form_control_1">Toplam Tutar</label>
                    <div className="col-md-10">
                  ...
                  <div className="form-group form-md-line-input has-success">
                    <label className="col-md-2 control-label" htmlFor="form_control_1">Sipariş Detayları</label>
                    <div className="col-md-10">
                  ...
                  <div className="form-group form-md-line-input">
                    <label className="col-md-2 control-label" htmlFor="form_control_1">Sipariş Durumu</label>
                    <div className="col-md-10">
                      <select className="form-control" id="form_control_1">
                        <option value>Lütfen seçiniz..</option>
