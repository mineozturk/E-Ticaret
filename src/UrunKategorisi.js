...
function UrunKategorisi() {
  const [allCategoryofProducts, setAllCategoryofProducts] = useState([]);
  useEffect(() => {
    const getAllCategoryofProductInfo = async () => {
      let response = await axios.get(
        'https://private-4efb96-urunkategorisi3.apiary-mock.com/UrunKategorisi'
      );

      console.log("getAllCategoryofProductInfo" + response.data.UrunKategoriListesi);

      setAllCategoryofProducts(response.data.UrunKategoriListesi);

    }

    // call the function
    getAllCategoryofProductInfo().catch(console.error);
                  ...
                  <div className="portlet light">
                    <div className="portlet-title">
                      <div className="caption">
                        ...
                        <span className="caption-subject font-green-sharp bold uppercase">All in One Bootstrap 3.0 Responsive Table</span>
                      </div>
                      <div className="tools">
                    ...
                    <div className="portlet-body">
                      <div className="table-responsive">
                        <table className="table table-striped table-bordered table-hover">
                          ...
                          <tbody>
                          {
                            allCategoryofProducts.map((data) => (
                              <>
                                <tr>
                                  <td>{data.ID}</td>
                                  <td>{data.UrunAdi}</td>
