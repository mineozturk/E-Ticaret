...
function YeniMusteri() {
  ...
  const myButtonClick = async () => {
    ...
    const response = await axios.post(
      'https://private-e728ef-mineozturk.apiary-mock.com/Musteri',
      requestBody
    );
  ...
  useEffect(() => {
    ...
    const getGenders = async () => {
          let response1 = await axios.get(
            'https://private-c21790-cinsiyet3.apiary-mock.com/Cinsiyet'
          );
    ...
    const getCities = async () => {
      let response = await axios.get(
          'https://private-9c5049-sehir2.apiary-mock.com/Sehir'
          );
